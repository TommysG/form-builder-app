...
const type: WidgetsType = "Checkbox";
...
export const CheckboxWidget: FormWidget = {
  type,
  construct: (id: string) => ({
    id,
    type,
  ...
  builderComponent: DesignerComponent,
    ...
    <div className="flex items-top space-x-2">
      <Checkbox
        ...
        onCheckedChange={(checked) => {
          ...
          const valid = CheckboxWidget.validate(element, stringValue);
          setError(!valid);
